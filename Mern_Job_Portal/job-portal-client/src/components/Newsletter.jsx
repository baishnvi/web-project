  ...
  return (
    <div>
        <div>
            ...
            <p className="text-primary/75 text-base mb-4">Ut ease eiusmod auto. Sit enim labore dolore.
            Auto eafugiat commodo foes.</p>

            <div className="w-full space-y-4">
                <input type="eamil" name="email" placeholder="name@mail.com" className="w-full block py-2
