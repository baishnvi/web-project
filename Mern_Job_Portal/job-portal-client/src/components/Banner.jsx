...
const Banner = ({query ,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        <h1 className='text-5xl font-bold text-primary md-3'>Find your <span className='text-blue'>
            new job</span>today</h1>
            <p className='text-lg text-black/70 mb-8'>Thousands of jobs in the computer, engineering and technology
            sector are waiting for you.</p>
       ...
       <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                ...
                className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text-900 
