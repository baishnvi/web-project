...
import './About.css'
import about_img from '../../assets/images (6).jpeg'
import play_icon from '../../assets/images (5).jpeg'
  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>Whether you aspire to become a teacher, administrartor,
            counselor, or educational leader, our diverse range of programs
            offers the perfect pathway to achieve your goals and unclock your
